...
# --------------------------------------------------------
config.track = edict()
config.track.train = edict()
config.track.train.enable = False
config.track.train.train_pair = False
config.track.train.MIN_OFFSET = 1
config.track.train.MAX_OFFSET = 10
# --------------------------------------------------------
